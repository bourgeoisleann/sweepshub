            ...
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-lg font-bold text-gold-300 mb-2">{method.title}</h3>
                  ...
                  <motion.a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gold-500 to-amber-500 hover:from-amber-500 hover:to-gold-500 text-dark-950 rounded-lg font-bold text-sm transition-all duration-200"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl font-bold text-base overflow-hidden shadow-xl"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
      ...
      <section className="py-6">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-gradient-to-br from-gold-500/10 to-amber-500/10 p-4 rounded-xl border border-gold-500/30">
              <h3 className="text-lg font-bold text-gold-300 mb-2">Business Hours</h3>
              <p className="text-gray-300 text-sm mb-2">We typically respond within 1-2 hours during business hours</p>
