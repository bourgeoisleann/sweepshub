            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl w-full">
              {paymentMethods.map((method, index) => (
                <motion.a
                  ...
                  className="group relative bg-gradient-to-b from-dark-800 to-dark-900 rounded-xl overflow-hidden border border-gold-500/20 hover:border-gold-500/50 transition-all duration-300 p-3"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    <div className="w-12 h-12 mb-2 rounded-lg overflow-hidden bg-white flex items-center justify-center p-1.5 group-hover:scale-110 transition-transform duration-300">
                      <img 
                        src={method.logo}
                    ...
                    <h3 className="text-base font-bold text-gold-300 group-hover:text-gold-200 transition-colors duration-200">
                      {method.name}
                    </h3>
                  </div>
                </motion.a>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {paymentFeatures.map((feature, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <div className="w-10 h-10 bg-gradient-to-br from-gold-500/20 to-amber-500/20 rounded-lg flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
      ...
      <section className="py-6">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="w-12 h-12 bg-gradient-to-br from-gold-500/20 to-amber-500/20 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-3 text-center">
              <div className="bg-dark-800/50 p-3 rounded-lg border border-gold-500/20">
                <h3 className="text-sm font-bold text-gold-300 mb-1">SSL Encryption</h3>
                <p className="text-gray-400 text-sm">256-bit SSL encryption for all transactions</p>
              </div>
              <div className="bg-dark-800/50 p-3 rounded-lg border border-gold-500/20">
                <h3 className="text-sm font-bold text-gold-300 mb-1">PCI Compliant</h3>
                <p className="text-gray-400 text-sm">Fully compliant with payment card industry standards</p>
              </div>
              <div className="bg-dark-800/50 p-3 rounded-lg border border-gold-500/20">
                <h3 className="text-sm font-bold text-gold-300 mb-1">24/7 Monitoring</h3>
